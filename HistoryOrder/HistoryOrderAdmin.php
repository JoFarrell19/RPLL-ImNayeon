        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../HistoryOrder/ChangeOrderStatusAdmin.php">Change Order Status</a></li>
                        <li class="nav-item"><a class="nav-link" href="../Main_Menu_Admin/MainMenu_Admin.php">Back to Main Menu</a></li>
                    </ul>
                </div>
            </div>
        </nav>
