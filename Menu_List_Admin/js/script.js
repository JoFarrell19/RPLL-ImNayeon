$(document).ready(function () {
	...
	$('.edit_menu').click(function () {
		// Change the current URL to the Edit_Menu.html page
		window.location.href = '../Edit_Menu/Edit_Menu.html';

		// Add a transition effect to the page transition
	...
	$('.delete_menu').click(function () {
		...
		$.ajax({
			...
			success: function (response) {
				// Reload the page after the item has been deleted
				location.reload();
			},
